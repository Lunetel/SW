        ...
        3. 계속 반복하면서
            ...
            3-3. 아니면
                ...
                3-3-3. 아니고 만약 2번 카페라뗴이면
                    3-3-3-1. 총 금액 = 2500원 * 잔 수
                3-3-4. 아니고 만약 3번 레몬에이드이면
                    3-3-4-1. 총금액 = 2000원 * 잔 수
        4. 만약에 총 금액이 0이면
            4-1. 감사합니다.
        5. 아니면
            5-1. 총 금액을 출력
...
while True :        # 주문을 무한반복한다.
    ...
    while True : 
        choice = int(input("주문할 음료의 번호를 입력하세요. (0 입력 시 주문 종료 됩니다.) : "))
        if choice == 0 : 
            break
        elif choice < 0 or choice > 3 :         # 잘못된 주문 번호 입력
            print("올바른 번호를 입력하세요.")
