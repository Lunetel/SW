...
favor_fruits = input("좋아하는 과일은? : ")

# 사용자가 입력한 과일이 리스트에 있는지 판단.
# 만약에 입력한 과일이 리스트에 있다면..
if favor_fruits in fruits : 
    print(f"{favor_fruits}는 당신이 좋아하는 과일 입니다.")
else : 
    print(f"{favor_fruits}는 당신이 좋아하는 과일이 아닙니다.")