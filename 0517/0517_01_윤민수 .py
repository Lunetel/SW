...
# 5명의 이름과 전화번호 저장
phone_book3 = {'윤민수' : '010-1234-5678', '홍길동' : '010-2345-6789', '개길동' : '010-5678-1234', '고길동' : '010-3456-7890', '배길동' : '010-4567-8901'}
print("phone_book3 : ", phone_book3)

print("phone_book3의 모든 key 출력 : ", phone_book3.keys())
print("phone_book3의 모든 key 출력 : ", phone_book3.values())
...
person_dict = {'name' : '윤민수', 'age' : 20, 'class' : '1학년'}
